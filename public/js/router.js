...
vue__WEBPACK_IMPORTED_MODULE_0__.default.use(vue_router__WEBPACK_IMPORTED_MODULE_1__.default); // コンポーネントをインポート
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new vue_router__WEBPACK_IMPORTED_MODULE_1__.default({
  ...
  routes: [{
    ...
    path: '/',
    // 名前付きルートを設定したい場合付与
    name: _components_ExampleComponent_vue__WEBPACK_IMPORTED_MODULE_2__.default,
    // コンポーネントの指定
